...
namespace FtpUtils
{
    class FtpHelper
    {
        ...
        {
            FtpHelper ftpHelper = new FtpHelper("192.168.137.1", "Administrator", "001223pp");
            FileInfo fileInfo = new FileInfo("d:\\outPut.txt");
            ftpHelper.Upload(fileInfo, "outPut.txt");
            //下载
            ftpHelper.Download("outPut.txt", "D:\\aaa.txt");
            //上传
